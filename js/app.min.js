...
eval("var canUseDOM = !!(\n  typeof window !== 'undefined' &&\n  window.document &&\n  window.document.createElement\n);\n\nmodule.exports = canUseDOM;\n\n//# sourceURL=webpack://gulp_start/./node_modules/can-use-dom/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/** Detect free variable `global` from Node.js. */\nvar freeGlobal = typeof global == 'object' && global && global.Object === Object && global;\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (freeGlobal);\n\n\n//# sourceURL=webpack://gulp_start/./node_modules/lodash-es/_freeGlobal.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/** Used for built-in method references. */\nvar objectProto = Object.prototype;\n\n/**\n * Used to resolve the\n * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)\n * of values.\n */\nvar nativeObjectToString = objectProto.toString;\n\n/**\n * Converts `value` to a string using `Object.prototype.toString`.\n *\n * @private\n * @param {*} value The value to convert.\n * @returns {string} Returns the converted string.\n */\nfunction objectToString(value) {\n  return nativeObjectToString.call(value);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (objectToString);\n\n\n//# sourceURL=webpack://gulp_start/./node_modules/lodash-es/_objectToString.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/**\n * Checks if `value` is object-like. A value is object-like if it's not `null`\n * and has a `typeof` result of \"object\".\n *\n * @static\n * @memberOf _\n * @since 4.0.0\n * @category Lang\n * @param {*} value The value to check.\n * @returns {boolean} Returns `true` if `value` is object-like, else `false`.\n * @example\n *\n * _.isObjectLike({});\n * // => true\n *\n * _.isObjectLike([1, 2, 3]);\n * // => true\n *\n * _.isObjectLike(_.noop);\n * // => false\n *\n * _.isObjectLike(null);\n * // => false\n */\nfunction isObjectLike(value) {\n  return value != null && typeof value == 'object';\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (isObjectLike);\n\n\n//# sourceURL=webpack://gulp_start/./node_modules/lodash-es/isObjectLike.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions.js */ \"./src/js/files/functions.js\");\n/* harmony import */ var _modules_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules.js */ \"./src/js/files/modules.js\");\n\r\n\r\n\r\n\r\nif (document.querySelector('.form-sing__eye')) {\r\n\tconst passEyeBtns = document.querySelectorAll('.form-sing__eye')\r\n\tpassEyeBtns.forEach(passEyeBtn => {\r\n\t\tpassEyeBtn.addEventListener('mousedown', e => {\r\n\t\t\te.preventDefault()\r\n\t\t\tconst passInput = passEyeBtn.parentElement.querySelector('input')\r\n\t\t\tpassInput.getAttribute('type') == 'password' ?\r\n\t\t\t\tpassInput.setAttribute('type', 'text') :\r\n\t\t\t\tpassInput.setAttribute('type', 'password')\r\n\t\t})\r\n\r\n\t})\r\n}\r\n\r\n\r\n\r\nif (document.querySelector('.header')) {\r\n\tconst header = document.querySelector('.header')\r\n\twindow.addEventListener('scroll', () => {\r\n\t\tif (window.scrollY > 0) header.classList.add('scroll-header')\r\n\t\telse header.classList.remove('scroll-header')\r\n\t})\r\n}\r\nif (document.querySelector('.theme-header__btn')) {\r\n\r\n\tconst themeBtns = document.querySelectorAll('.theme-header__btn')\r\n\tthemeBtns.forEach(themeBtn => {\r\n\t\tthemeBtn.addEventListener('click', () => {\r\n\t\t\tconst targetTheme = themeBtn.dataset.theme\r\n\t\t\tif (window.innerWidth < 480) {\r\n\t\t\t\tif (targetTheme == \"dark\") {\r\n\t\t\t\t\tdocument.querySelector('body').classList.add('dark-theme')\r\n\t\t\t\t\tlocalStorage.setItem('theme', 'dark')\r\n\t\t\t\t} else {\r\n\t\t\t\t\tdocument.querySelector('body').classList.remove('dark-theme')\r\n\t\t\t\t\tlocalStorage.removeItem('theme')\r\n\t\t\t\t}\r\n\t\t\t} else {\r\n\t\t\t\tif (document.body.classList.contains('dark-theme')) {\r\n\t\t\t\t\tdocument.querySelector('body').classList.remove('dark-theme')\r\n\t\t\t\t\tlocalStorage.removeItem('theme')\r\n\t\t\t\t} else {\r\n\t\t\t\t\tdocument.querySelector('body').classList.add('dark-theme')\r\n\t\t\t\t\tlocalStorage.setItem('theme', 'dark')\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t\t(0,_functions_js__WEBPACK_IMPORTED_MODULE_0__.menuClose)()\r\n\t\t})\r\n\t})\r\n}\r\nif (document.querySelector('.left-help-spollers__title')) {\r\n\tconst spollerLinks = document.querySelectorAll('.left-help-spollers__title')\r\n\tspollerLinks.forEach(spollerLink => {\r\n\t\tspollerLink.addEventListener('click', () => {\r\n\t\t\tconst link = spollerLink.getAttribute('href')\r\n\t\t\tsetTimeout(() => window.location.replace(link), 300)\r\n\t\t})\r\n\t})\r\n}\r\n// setSpollerAction(document.querySelector('.right-help-spollers__title'))\r\nif (document.querySelector('.left-help-spollers__body button')) {\r\n\tconst leftHelpBtns = document.querySelectorAll('.left-help-spollers__body button')\r\n\tleftHelpBtns.forEach(leftHelpBtn => {\r\n\t\tleftHelpBtn.addEventListener('click', () => {\r\n\t\t\tconst spollerTargetName = leftHelpBtn.dataset.targetSpoller\r\n\t\t\tconst spollerTarget = document?.querySelector(spollerTargetName)\r\n\t\t\tspollerTarget.classList.toggle('_spoller-active')\r\n\t\t\t;(0,_functions_js__WEBPACK_IMPORTED_MODULE_0__._slideToggle)(spollerTarget.nextElementSibling)\r\n\t\t})\r\n\r\n\t})\r\n}\r\nif (document.querySelector('.form-validate')) {\r\n\tconst formItems = document.querySelectorAll('.form-validate')\r\n\tlet passValue\r\n\tlet errors = 0\r\n\tformItems.forEach(formItem => {\r\n\t\tconst btnForm = formItem.querySelector(`button:not([type=\"button\"])`)\r\n\t\tconst emptyMsg = formItem.querySelector('.form-msg__empty')?.textContent\r\n\t\tconst emptySelSend = formItem.querySelector('.form-msg__sel-empty-send')?.textContent\r\n\t\tconst passLengthMsg = formItem.querySelector('.form-msg__pass-length')?.textContent\r\n\t\tconst passOtherMsg = formItem.querySelector('.form-msg__pass-other')?.textContent\r\n\t\tconst passConfMsg = formItem.querySelector('.form-msg__pass-conf')?.textContent\r\n\t\tconst passInfoMsg = formItem.querySelector('.form-msg__pass')?.textContent\r\n\t\tconst emailMsg = formItem.querySelector('.form-msg__email')?.textContent\r\n\t\tconst phoneMsg = formItem.querySelector('.form-msg__phone')?.textContent\r\n\t\tconst urlMsg = formItem.querySelector('.form-msg__url')?.textContent\r\n\t\tconst checkMsg = formItem.querySelector('.form-msg__check')?.textContent\r\n\t\tconst wrongMsg = formItem.querySelector('.form-msg__wrong')?.textContent\r\n\t\tconst passInp = formItem.querySelector('.req-pass')\r\n\t\tconst reqInputs = formItem.querySelectorAll('.req, .req-check, .req-sel, .req-email, .req-phone, .req-pass, .req-pass-conf, .req-url')\r\n\t\treqInputs.forEach(reqInput => {\r\n\t\t\treqInput.addEventListener('blur', () => {\r\n\t\t\t\tlet errorMessage = document.createElement('span')\r\n\t\t\t\terrorMessage.classList.add(\"error-message\")\r\n\t\t\t\tif (reqInput.classList.contains('req-sel')) {\r\n\t\t\t\t\tconst selValue = reqInput.querySelector('select').value\r\n\t\t\t\t\tif (selValue == 1) {\r\n\t\t\t\t\t\tif (!reqInput.classList.contains('error-sel')) {\r\n\t\t\t\t\t\t\treqInput.classList.add('error-sel')\r\n\t\t\t\t\t\t\terrorMessage.textContent = emptyMsg\r\n\t\t\t\t\t\t\treqInput.after(errorMessage)\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t\tif (!reqInput.value && (reqInput.classList.contains('req') ||\r\n\t\t\t\t\treqInput.classList.contains('req-pass-conf') ||\r\n\t\t\t\t\treqInput.classList.contains('req-email') ||\r\n\t\t\t\t\treqInput.classList.contains('req-phone'))) {\r\n\t\t\t\t\tif (!reqInput.classList.contains('error-text')) {\r\n\t\t\t\t\t\treqInput.classList.add('error-text')\r\n\t\t\t\t\t\terrorMessage.textContent = emptyMsg\r\n\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('req-check') && !reqInput.checked) {\r\n\t\t\t\t\tif (!reqInput.classList.contains('error-check')) {\r\n\t\t\t\t\t\treqInput.classList.add('error-check')\r\n\t\t\t\t\t\terrorMessage.textContent = checkMsg\r\n\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('req-pass')) {\r\n\t\t\t\t\tpassValue = reqInput.value\r\n\t\t\t\t\tconst patternNum = /\\d/\r\n\t\t\t\t\tconst patternSym = /[.,:;?!-()*^%$#]/\r\n\t\t\t\t\tconst patternWord = /[a-zA-Z]/\r\n\t\t\t\t\tconst inputValue = reqInput.value\r\n\t\t\t\t\tif (reqInput.parentElement?.nextElementSibling?.classList.contains('pass-msg') ||\r\n\t\t\t\t\t\treqInput.parentElement?.nextElementSibling?.classList.contains('error-message')) {\r\n\t\t\t\t\t\treqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t\t}\r\n\t\t\t\t\tif (inputValue) {\r\n\t\t\t\t\t\tif (reqInput.parentElement?.nextElementSibling?.classList.contains('pass-msg')) reqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t\t\tif (inputValue.length < 6) {\r\n\t\t\t\t\t\t\tif (!reqInput.classList.contains('error-pass')) {\r\n\t\t\t\t\t\t\t\treqInput.classList.add('error-pass')\r\n\t\t\t\t\t\t\t\terrorMessage.textContent = passLengthMsg\r\n\t\t\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t} else if (!patternNum.test(inputValue) || !patternSym.test(inputValue) || !patternWord.test(inputValue)) {\r\n\t\t\t\t\t\t\tif (!reqInput.classList.contains('error-pass')) {\r\n\t\t\t\t\t\t\t\treqInput.classList.add('error-pass')\r\n\t\t\t\t\t\t\t\terrorMessage.innerHTML = passOtherMsg\r\n\t\t\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('req-pass-conf')) {\r\n\t\t\t\t\tconst inputValue = reqInput.value\r\n\t\t\t\t\tif (inputValue !== passValue && inputValue) {\r\n\t\t\t\t\t\tif (!reqInput.classList.contains('error-pass-conf')) {\r\n\t\t\t\t\t\t\treqInput.classList.add('error-pass-conf')\r\n\t\t\t\t\t\t\terrorMessage.textContent = passConfMsg\r\n\t\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('req-email')) {\r\n\t\t\t\t\tconst pattern = /^[a-z0-9._-]+@[a-z0-9.-]+\\.[a-z]{2,6}$/\r\n\t\t\t\t\tconst inputValue = reqInput.value.toLowerCase()\r\n\t\t\t\t\tif (!inputValue.match(pattern) && reqInput.value) {\r\n\t\t\t\t\t\tif (!reqInput.classList.contains('error-email')) {\r\n\t\t\t\t\t\t\treqInput.classList.add('error-email')\r\n\t\t\t\t\t\t\terrorMessage.textContent = emailMsg\r\n\t\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('req-phone')) {\r\n\t\t\t\t\tconst inputValue = reqInput.value\r\n\t\t\t\t\tif (!+inputValue && reqInput.value) {\r\n\t\t\t\t\t\tif (!reqInput.classList.contains('error-phone')) {\r\n\t\t\t\t\t\t\treqInput.classList.add('error-phone')\r\n\t\t\t\t\t\t\terrorMessage.textContent = phoneMsg\r\n\t\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('req-url')) {\r\n\t\t\t\t\tconst pattern = /^(https?:\\/\\/)?([a-z0-9]+(-[a-z0-9]+)*\\.)+[a-z]{2,}(\\/\\S*)?$/;\r\n\t\t\t\t\tconst inputValue = reqInput.value\r\n\t\t\t\t\tif (!pattern.test(inputValue) && inputValue) {\r\n\t\t\t\t\t\tif (!reqInput.classList.contains('error-url')) {\r\n\t\t\t\t\t\t\treqInput.classList.add('error-url')\r\n\t\t\t\t\t\t\terrorMessage.textContent = urlMsg\r\n\t\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t\treqInput.addEventListener('focus', () => {\r\n\t\t\t\tif (reqInput.classList.contains('error-text')) {\r\n\t\t\t\t\treqInput.classList.remove('error-text')\r\n\t\t\t\t\treqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('error-email')) {\r\n\t\t\t\t\treqInput.classList.remove('error-email')\r\n\t\t\t\t\treqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('error-phone')) {\r\n\t\t\t\t\treqInput.classList.remove('error-phone')\r\n\t\t\t\t\treqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('error-pass')) {\r\n\t\t\t\t\treqInput.classList.remove('error-pass')\r\n\t\t\t\t\treqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('error-pass-conf')) {\r\n\t\t\t\t\treqInput.classList.remove('error-pass-conf')\r\n\t\t\t\t\treqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('error-url')) {\r\n\t\t\t\t\treqInput.classList.remove('error-url')\r\n\t\t\t\t\treqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t}\r\n\t\t\t\tif (reqInput.classList.contains('error-check')) {\r\n\t\t\t\t\treqInput.classList.remove('error-check')\r\n\t\t\t\t\treqInput.parentElement?.nextElementSibling?.remove()\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t})\r\n\t\tconst validateReq = reqInput => {\r\n\t\t\tlet errorMessage = document.createElement('span')\r\n\t\t\terrorMessage.classList.add(\"error-message\")\r\n\t\t\tif (reqInput.classList.contains('req-sel')) {\r\n\t\t\t\tconst selValue = reqInput.querySelector('select').value\r\n\t\t\t\tconst selInput = reqInput.querySelector('input').value\r\n\t\t\t\tif (selValue == 1) {\r\n\t\t\t\t\tif (!reqInput.classList.contains('error-sel')) {\r\n\t\t\t\t\t\treqInput.classList.add('error-sel')\r\n\t\t\t\t\t\tif (selInput) errorMessage.textContent = emptySelSend\r\n\t\t\t\t\t\telse errorMessage.textContent = emptyMsg\r\n\t\t\t\t\t\treqInput.after(errorMessage)\r\n\t\t\t\t\t}\r\n\t\t\t\t\terrors++\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t\tif (!reqInput.value && (reqInput.classList.contains('req') ||\r\n\t\t\t\treqInput.classList.contains('req-pass-conf') ||\r\n\t\t\t\treqInput.classList.contains('req-email') ||\r\n\t\t\t\treqInput.classList.contains('req-phone'))) {\r\n\t\t\t\tif (!reqInput.classList.contains('error-text')) {\r\n\t\t\t\t\treqInput.classList.add('error-text')\r\n\t\t\t\t\terrorMessage.textContent = emptyMsg\r\n\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t}\r\n\t\t\t\terrors++\r\n\t\t\t}\r\n\t\t\tif (reqInput.classList.contains('req-check') && !reqInput.checked) {\r\n\t\t\t\tif (!reqInput.classList.contains('error-check')) {\r\n\t\t\t\t\treqInput.classList.add('error-check')\r\n\t\t\t\t\terrorMessage.textContent = checkMsg\r\n\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t}\r\n\t\t\t\terrors++\r\n\t\t\t}\r\n\t\t\tif (reqInput.classList.contains('req-pass')) {\r\n\t\t\t\tpassValue = reqInput.value\r\n\t\t\t\tconst patternNum = /\\d/\r\n\t\t\t\tconst patternSym = /[.,:;?!-()*^%$#]/\r\n\t\t\t\tconst patternWord = /[a-zA-Z]/\r\n\t\t\t\tconst inputValue = reqInput.value\r\n\t\t\t\tif (reqInput.value) {\r\n\t\t\t\t\tif (inputValue.length < 6) {\r\n\t\t\t\t\t\tif (!reqInput.classList.contains('error-pass')) {\r\n\t\t\t\t\t\t\treqInput.classList.add('error-pass')\r\n\t\t\t\t\t\t\terrorMessage.textContent = passLengthMsg\r\n\t\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\terrors++\r\n\t\t\t\t\t} else if (!patternNum.test(inputValue) || !patternSym.test(inputValue) || !patternWord.test(inputValue)) {\r\n\t\t\t\t\t\tif (!reqInput.classList.contains('error-pass')) {\r\n\t\t\t\t\t\t\treqInput.classList.add('error-pass')\r\n\t\t\t\t\t\t\terrorMessage.innerHTML = passOtherMsg\r\n\t\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\terrors++\r\n\t\t\t\t\t}\r\n\t\t\t\t} else {\r\n\t\t\t\t\tif (!reqInput.parentElement?.nextElementSibling?.classList.contains('pass-msg')) {\r\n\t\t\t\t\t\tlet passMsg = document.createElement('span')\r\n\t\t\t\t\t\tpassMsg.classList.add(\"pass-msg\")\r\n\t\t\t\t\t\tpassMsg.innerHTML = passInfoMsg\r\n\t\t\t\t\t\tpassInp.parentElement?.after(passMsg)\r\n\t\t\t\t\t}\r\n\t\t\t\t\terrors++\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t\tif (reqInput.classList.contains('req-pass-conf')) {\r\n\t\t\t\tconst inputValue = reqInput.value\r\n\t\t\t\tif (inputValue !== passValue && inputValue) {\r\n\t\t\t\t\tif (!reqInput.classList.contains('error-pass-conf')) {\r\n\t\t\t\t\t\treqInput.classList.add('error-pass-conf')\r\n\t\t\t\t\t\terrorMessage.textContent = passConfMsg\r\n\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t}\r\n\t\t\t\t\terrors++\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t\tif (reqInput.classList.contains('req-email')) {\r\n\t\t\t\tconst pattern = /^[a-z0-9._-]+@[a-z0-9.-]+\\.[a-z]{2,6}$/\r\n\t\t\t\tconst inputValue = reqInput.value.toLowerCase()\r\n\t\t\t\tif (!inputValue.match(pattern) && reqInput.value) {\r\n\t\t\t\t\tif (!reqInput.classList.contains('error-email')) {\r\n\t\t\t\t\t\treqInput.classList.add('error-email')\r\n\t\t\t\t\t\terrorMessage.textContent = emailMsg\r\n\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t}\r\n\t\t\t\t\terrors++\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t\tif (reqInput.classList.contains('req-phone')) {\r\n\t\t\t\tconst inputValue = reqInput.value\r\n\t\t\t\tif (!+inputValue && reqInput.value) {\r\n\t\t\t\t\tif (!reqInput.classList.contains('error-phone')) {\r\n\t\t\t\t\t\treqInput.classList.add('error-phone')\r\n\t\t\t\t\t\terrorMessage.textContent = phoneMsg\r\n\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t}\r\n\t\t\t\t\terrors++\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t\tif (reqInput.classList.contains('req-url')) {\r\n\t\t\t\tconst pattern = /^(https?:\\/\\/)?([a-z0-9]+(-[a-z0-9]+)*\\.)+[a-z]{2,}(\\/\\S*)?$/;\r\n\t\t\t\tconst inputValue = reqInput.value\r\n\t\t\t\tif (!pattern.test(inputValue) && inputValue) {\r\n\t\t\t\t\tif (!reqInput.classList.contains('error-url')) {\r\n\t\t\t\t\t\treqInput.classList.add('error-url')\r\n\t\t\t\t\t\terrorMessage.textContent = urlMsg\r\n\t\t\t\t\t\treqInput.parentElement?.after(errorMessage)\r\n\t\t\t\t\t}\r\n\t\t\t\t\terrors++\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t\tbtnForm.addEventListener('click', e => {\r\n\t\t\treqInputs.forEach(reqInput => validateReq(reqInput))\r\n\t\t\twrongMessage()\r\n\t\t\tif (errors) {\r\n\t\t\t\te.preventDefault()\r\n\t\t\t\terrors = 0\r\n\t\t\t}\r\n\t\t})\r\n\t\tpassInp?.addEventListener('focus', () => {\r\n\t\t\tif (!passInp.classList.contains('error-pass') &&\r\n\t\t\t\t!passInp.value &&\r\n\t\t\t\t!passInp.parentElement?.nextElementSibling?.classList.contains('pass-msg')) {\r\n\t\t\t\tlet passMsg = document.createElement('span')\r\n\t\t\t\tpassMsg.classList.add(\"pass-msg\")\r\n\t\t\t\tpassMsg.innerHTML = passInfoMsg\r\n\t\t\t\tpassInp.parentElement?.after(passMsg)\r\n\t\t\t}\r\n\t\t})\r\n\t\tdocument.addEventListener(\"selectCallback\", function (e) {\r\n\t\t\tconst currentSelect = e.detail.select\r\n\t\t\tcurrentSelect.closest('.form-sing__line').classList.remove('error-sel')\r\n\t\t\tcurrentSelect.closest('.form-sing__line')?.nextElementSibling?.remove()\r\n\t\t});\r\n\t\tfunction wrongMessage() {\r\n\t\t\tif (formItem.classList.contains('sign-in')) {\r\n\t\t\t\tconst itemLines = formItem.querySelector('.form-sing__lines')\r\n\t\t\t\tif (!itemLines.nextElementSibling.classList.contains('error-message')) {\r\n\t\t\t\t\tlet errorMessage = document.createElement('span')\r\n\t\t\t\t\terrorMessage.classList.add(\"error-message\")\r\n\t\t\t\t\terrorMessage.textContent = wrongMsg\r\n\t\t\t\t\titemLines.after(errorMessage)\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t})\r\n}\r\n\n\n//# sourceURL=webpack://gulp_start/./src/js/files/script.js?");
